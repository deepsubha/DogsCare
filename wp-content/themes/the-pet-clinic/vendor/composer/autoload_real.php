...
class The_Pet_Clinic_ComposerAutoloaderInit75f95ca3778976eb5c1bf35fe42ac3d4
{
    private static $loader;

    public static function the_pet_clinic_loadClassLoader($class)
    {
    ...
    public static function the_pet_clinic_getLoader()
    {
        if (null !== self::$loader) {
            return self::$loader;
        }
