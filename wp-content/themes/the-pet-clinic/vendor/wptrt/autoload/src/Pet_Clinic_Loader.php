...
class The_Pet_Clinic_Loader {
	 ...
	 * @return void
	 */
	public function the_pet_clinic_add( $prefix, $paths ) {
	 ...
	 * @return void
	 */
	public function the_pet_clinic_remove( $prefix, $path = '' ) {
	 ...
	 * @return bool
	 */
	public function the_pet_clinic_has( $prefix, $path = '' ) {
		if ( $path ) {
	 ...
	 * @return void
	 */
	public function the_pet_clinic_register() {

		if ( $this->loaders ) {

			spl_autoload_register( function( $class ) {

				$this->the_pet_clinic_load( $class );
			}, true, true );
		}
	}
	/**
	 ...
	 * @return void
	 */
	protected function the_pet_clinic_load( $class ) {
