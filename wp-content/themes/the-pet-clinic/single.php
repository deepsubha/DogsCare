					    	...
					    	<section id="post_section">
								...
								while ( have_posts() ) : the_post();
									...
									the_post_navigation( array(
										'prev_text' => '<span class="screen-reader-text">' . __( 'Previous Post', 'the-pet-clinic' ) . '</span><span aria-hidden="true" class="nav-subtitle">' . __( 'Previous', 'the-pet-clinic' ) . '</span>',
										'next_text' => '<span class="screen-reader-text">' . __( 'Next Post', 'the-pet-clinic' ) . '</span><span aria-hidden="true" class="nav-subtitle">' . __( 'Next', 'the-pet-clinic' ) . '</span> ',
									) );
