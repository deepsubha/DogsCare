...
<div class="container">
	...
	<header class="page-header">
		<?php if ( have_posts() ) : ?>
			<h2 class="search-title"><?php /* translators: %s: search term */ printf( esc_html__( 'Search Results for: %s','the-pet-clinic'), '<span>' . esc_html( get_search_query() ) . '</span>' ); ?></h2>
		<?php else : ?>
			<h3 class="page-title"><?php esc_html_e( 'Nothing Found', 'the-pet-clinic' ); ?></h3>
		<?php endif; ?>
	</header>

	<div class="content-area">
		<main id="wp-toolbar" class="site-main" role="main">
			<?php $layout_option = get_theme_mod( 'the_pet_clinic_theme_options',__( 'Right Sidebar','the-pet-clinic' ) );
				        ...
				        <div id="" class="content_area col-lg-8 col-md-8">
					    	<section id="post_section">
								...
								if ( have_posts() ) :
									...
									<p><?php esc_html_e( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'the-pet-clinic' ); ?></p>
									<?php
										get_search_form();
