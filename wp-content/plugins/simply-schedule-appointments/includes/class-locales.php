...
class SSA_Locales {
	...
	public static function &instance() {
		if ( ! isset( $GLOBALS['gp_locales'] ) )
			$GLOBALS['gp_locales'] = new SSA_Locales;

		return $GLOBALS['gp_locales'];
	}

	public static function locales() {
		$instance = SSA_Locales::instance();
