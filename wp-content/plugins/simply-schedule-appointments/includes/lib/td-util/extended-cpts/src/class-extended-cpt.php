...
class Extended_CPT {
	 ...
	 */
	public function registered_post_type( $post_type, WP_Post_Type $post_type_object ) {
	 ...
	 */
	public function post_type_link( $post_link, WP_Post $post, bool $leavename, bool $sample ) {
	 ...
	 */
	public function add_taxonomy( $taxonomy, array $args = [], array $names = [] ) {
